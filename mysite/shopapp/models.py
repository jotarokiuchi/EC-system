...
class Category(models.Model):
    ...
    nmae=models.CharField(verbose_name='name',max_length=256)
...
class Item(models.Model):
    ...
    manufacturer=models.CharField(verbose_name='メーカ-名',max_length=32)
    color=models.CharField(verbose_name='商品の色',max_length=16)
    price=models.IntegerField(verbose_name='価格')
    stock=models.IntegerField(verbose_name='在庫数')
    rccommended=models.BooleanField(verbose_name='オススメ',max_length=1,default=False)
...
class Cart(models.Model):
    ...
    user_id=models.ForeignKey(User,verbose_name='会員ID',on_delete=models.CASCADE)
...
class Purchase(models.Model):
    ...
    cancel=models.BooleanField(verbose_name='キャンセル',default=False,max_length=1)
